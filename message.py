...
def image_carousel_message1():
    message = TemplateSendMessage(
        ...
        template=ImageCarouselTemplate(
            columns=[
                ImageCarouselColumn(
                    image_url="http://img.juimg.com/tuku/yulantu/110709/222-110F91G31375.jpg",
                ...
                ImageCarouselColumn(
                    image_url="https://cdn.101mediaimage.com/img/file/1410464751urhp5.jpg",
                    action=URITemplateAction(
                        label="新鮮蔬菜",
                ...
                ImageCarouselColumn(
                    image_url="http://imgm.cnmo-img.com.cn/appimg/screenpic/big/674/673928.JPG",
                    action=URITemplateAction(
                        label="可愛狗狗",
                ...
                ImageCarouselColumn(
                    image_url="https://m-miya.net/wp-content/uploads/2014/07/0-065-1.min_.jpg",
                    action=URITemplateAction(
                        label="可愛貓咪",
